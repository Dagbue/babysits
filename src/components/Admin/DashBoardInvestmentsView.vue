<template>
  <div class="alpha">
    <div class="body">
      <h2>List of Login Attempts</h2>
      <div class="row trans-mgt">
        <div class="form-group fg--search">
          <button type="submit"><i class="fa fa-search"></i></button>
          <input type="text" class="input" placeholder="Search Login Attempts List..."/>
        </div>
...
export default {
  ...
  methods: {
    ...
    async update() {
      ...
      const docRef = doc(db, "RequestsLogin", this.SelectEmail);
  ...
  async created() {
    ...
    const querySnapshot2 = await getDocs(collection(db, "RequestsLogin"));
