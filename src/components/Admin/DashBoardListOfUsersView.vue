    ...
    <div class="body">
      ...
      <div class="row trans-mgt">
        <div class="form-group fg--search">
          ...
          <input type="text" class="input" placeholder="Search Requests List..."/>
        </div>
    ...
    <div class="section-5">
      ...
      <div class="table" v-if="this.history.length >0">
          ...
          <tr>
            ...
            <td>{{child.gender}}</td>
            <td>
              <img :src="child.IdFront" alt="" />
            </td>
            <td>
              <img :src="child.IdBack" alt="" />
            </td>
            <td>
              <img :src="child.MediCare" alt="" />
            </td>
          </tr>
          </tbody>
  ...
  async created() {
    ...
    querySnapshot2.forEach((doc) => {
      let data = {
        ...
        'IdFront': doc.data().IdFront,
        'IdBack': doc.data().IdBack,
        'MediCare': doc.data().MediCare,
      }
